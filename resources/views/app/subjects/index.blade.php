    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div class="flex items-center">
                <div class="p-2 rounded-full bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400 mr-3">
            ...
            <a href="{{ route('subjects.create') }}" class="inline-flex items-center px-4 py-2.5 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 shadow-sm hover:shadow transition-all duration-200">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($subjects as $subject)
                    <div class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-emerald-200 dark:hover:border-emerald-900">
                        ...
                        <div class="p-5">
                            <div class="flex justify-between items-center mb-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-gray-600 dark:text-gray-300">{{ $subject->students_count }} {{ Str::plural('student', $subject->students_count) }}</span>
                                </div>
                                <div class="flex items-center">
                                    <div class="p-1.5 rounded-md bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 mr-2">
                                        <i class="fas fa-tasks text-sm"></i>
                                    </div>
                                    <span class="text-sm text-gray-600 dark:text-gray-300">{{ $subject->activities_count }} {{ Str::plural('activity', $subject->activities_count) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="flex space-x-2 mt-4">
                                <a href="{{ route('subjects.show', $subject->id) }}" class="flex-1 inline-flex items-center justify-center px-3 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm shadow-sm">
                                ...
                                <a href="{{ route('activities.create', ['subject_id' => $subject->id]) }}" class="inline-flex items-center justify-center px-3 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm shadow-sm">
                ...
                @empty
                    <div class="col-span-full p-10 text-center bg-white dark:bg-gray-800 rounded-xl border border-dashed border-gray-200 dark:border-gray-700 shadow-sm">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('subjects.create') }}" class="inline-flex items-center px-5 py-2.5 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 shadow-sm hover:shadow transition-all duration-200">
                                <i class="fas fa-plus mr-2"></i>
                                Create Subject
                            </a>
                        </div>
